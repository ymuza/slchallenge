...
X_train = np.load("../SLChallenge/outputs/embeddings_test.npy")
labels = np.load("../SLChallenge/outputs/labels_test.npy")
X_test = np.load("../SLChallenge/outputs/embeddings_test.npy")  # los del conjunto real
