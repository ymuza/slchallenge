...
TRAIN_PATH = "../SLChallenge/outputs/embeddings.npy"  # AstroCLIP train (1024D)
TEST_PATH = "../SLChallenge/outputs/embeddings_test.npy"  # DINOv2 real (768D)
PDF_PATH = "../SLChallenge/outputs/domain_diagnostics_report.pdf"
PLOT_PATH = "../SLChallenge/outputs/domain_diagnostics_v3.png"
