...
"""
generador_de_embeddings_reales_y_CSV_para_challenge.py

anteriomente llamado : generador_de_embeddings_reales_y_CSV_para_challenge.py
...
# ------------------- CONFIG -------------------
DATASET_DIR = "/media/yamil/b5ef7208-1e9c-40d4-ab93-390950eedbce/astroclip_test_dataset/test_dataset_updated"
OUT_DIR = "SLChallenge/outputs"
...
FAILED_TXT   = os.path.join(OUT_DIR, "failed_ids.txt") # acá mando los ids de los archivos fallidos
FAILED_CSV   = os.path.join(OUT_DIR, "failed_report.csv") # reporte de fallas en el proceso
...
# DINOv2 espera 518x518, 3 canales, normalización similar a la oficial (ajustar or las dudas)
...
# Para IDs fallados → is_lens = -99, prob_lens=0.0, predicted_z=-1.0 (-99 como dice la pagina del challenge)
...
for bid in all_ids_sorted:
    if bid in failed_ids:
        ...
        i = id_to_idx_ok.get(bid, None) # (TODO: puede fallar por tipo acá??? REVISAR)
        if i is None:
